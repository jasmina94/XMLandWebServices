INSERT INTO `quatrofantasticoxmlcompany`.`firma` (`adresa`,`naziv`,`pib`,`mesto`) VALUES ("Pozeska BB", "Pionir d.o-o.", 111111111, "Beograd"), ("Zrenjaninski put 100", "Imlek", 222222222, "Beograd"), ("Jovana Cvijica 13", "Dijamant d.o.o.", 333333333, "Zrenjanin"), ("Bulevar Oslobodjenja 112", "3G Shop d.o-o.", 444444444, "Novi Sad");

INSERT INTO `quatrofantasticoxmlcompany`.`poslovni_partner` (`adresa`,`naziv`,`pib`,`firma_id`,`mesto`) VALUES ("Janka Cmelika 29", "MAX IMPORT-EXPORT",12121212, 1, "Novi Sad"), ("Gunduliceva 100", "4x4 OPREMA D.O.O",12121333, 2, "Beograd"), ("Stevana Sremca 13", "DEXI SHPED", 121245676, 1, "Sremska Mitrovica"), ("Prva proleterska 1", "MAXI",133345675, 1, "Kragujevac"), ("Zelengorska 13", "UNIVEREXPORT D.O.O.", 555555555, 1, "Novi Sad");

INSERT INTO `quatrofantasticoxmlcompany`.`zaposleni` (`adresa`,`ime`,`jmbg`,`prezime`,`lozinka`,`korisnicko_ime`,`firma_id`,`mesto`) VALUES ("Pariskih komuna 10","Pera", 1204966345060, "Peric","pera", "pera", 1, "Beograd"), ("Kikindska 68", "Mika", 2104966345060,"Mikic","mika", "mika", 1, "Beograd"), ("Zelengorska 2a","zika", 2901975345161, "zikic","zika", "zika", 2, "Beograd");
...
(111111, "2017-05-22","2017-05-23", 2, 27000.00, "RSD", 12000.00, 5000.00, 270000.00, "840-1234567884754-12", 20000.00, 70000.00, 1, 2);
